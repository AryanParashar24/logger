...
class LoggerTest extends TestCase
{
    ...
    public function testAdapters(): void
    {
        ...
        // Test Sentry
        $adapter = new Sentry(\getenv('https://9ff448ad01c7fc3f13591c0b3cdafb3c@o4506094190264320.ingest.sentry.io/4506094192820224') ?: '');
        $logger = new Logger($adapter);
        $response = $logger->addLog($log);
        $this->assertEquals(200, $response);

        // Test AppSignal
        $appSignalKey = \getenv('128ded4c-0a19-4731-b393-09af96601507');
        ...
        // Test Raygun
        $raygunKey = \getenv('kbCnblFruB7TUJcdspZLFOyoQJBVIHin');
        ...
        // Test LogOwl
        $logOwlKey = \getenv('AF9F0675C21139F07929D9F5F2F8FDC95C3B645F2568464CE2');
